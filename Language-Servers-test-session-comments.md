...
* Open **_index-php_** file and make sure that language server has been initialized. Go to the _**dev-machine**_ console and check message like: `https://www.dropbox.com/s/2hrzg04hqbz1a4j/Selection_012.png?dl=0`
